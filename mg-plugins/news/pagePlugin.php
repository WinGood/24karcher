            ...
            <div class="add-product-form-wrapper">
              ...
              <div class="add-img-form">
                <div class="product-text-inputs">
                  <label for="title">
                    <span class="custom-text"><?php echo $lang['NEWS_NAME'];?>:</span>
                    <input type="text" name="title" class="product-name-input tool-tip-right" title="<?php echo $lang['T_TIP_NEWS_NAME'];?>">
                    <div class="errorField"><?php echo $lang['ERROR_SPEC_SYMBOL'];?></div>
                  </label>
                  <label for="url">
                    <span class="custom-text"><?php echo $lang['NEWS_URL'];?>:</span>
                    <input type="text" name="url" class="product-name-input qty tool-tip-right" title="<?php echo $lang['T_TIP_NEWS_URL'];?>">
                ...
                <div class="product-upload-img">
                  <div class="product-img-prev">
                    ...
                    <a href="#" class="cancel-img-upload tool-tip-bottom" title="<?php echo $lang['T_TIP_DEL_IMG_PROD'];?>"></a>
                    <div class="clear"></div>
                  </div>
                </div>
                <div class="clear"></div>
                ...
                <div class="product-desc-wrapper">
                  <span class="custom-text" style="margin-bottom: 10px;"><?php echo $lang['NEWS_CONTENT'];?>:</span>
                  <div style="background:#FFF">
                    <textarea class="product-desc-field" name="html_content" id="newsEditor"  style="width:785px;"></textarea>
                  </div>
                </div>
                <div class="clear"></div>
                ...
                <div class="clear"></div>
                <button class="save-button tool-tip-bottom" title="<?php echo $lang['T_TIP_SAVE_NEWS'];?>">
    ...
    <div class="widget-table-body">
      ...
      <div class="main-settings-container">
        <table class="widget-table product-table">
          <thead>
            <tr>
              <th width="120"><?php echo $lang['IMAGE'];?></th>
