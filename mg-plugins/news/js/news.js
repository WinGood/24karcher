...
var news = (function () {
  return {
    wysiwyg: true, // HTML редактор для редактирования новости
        ...
        function(response) {
          ...
          var row='\
            <tr id="'+response.data.id+'">\
              ...
              <td class="url"><a class="tool-tip-bottom" href="'+admin.SITE+'/news/'+response.data.url+'" title="'+news.lang.T_TIP_GOTO_PAGE+'" target="_blank">'+response.data.url+'</a></td>\
              <td class="actions">\
                <ul class="action-list">\
                  <li class="edit-row tool-tip-bottom" id="'+response.data.id+'"><a href="#" title="'+news.lang.EDIT+'"></a></li>\
                  <li class="delete-order tool-tip-bottom" id="'+response.data.id+'"><a href="#"  title="'+news.lang.DELETE+'"></a></li>\
                </ul>\
              </td>\
           </tr>';
